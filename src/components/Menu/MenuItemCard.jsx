...
const MenuItemCard = ({ categoriesData, setSelectedCategory }) => {
  ...
  const manageMenuExplore = () => {
    ...
    console.log("categoriesDataClick", categoriesData.strCategory);
  }
    ...
    <div>
      ...
      >
        ...
        <div className="p-4 md:p-5">
          ...
          <button onClick={manageMenuExplore} className="mt-3.5 inline-flex items-center gap-2 font-bold text-[#63e6be] transition duration-200 hover:translate-x-1 hover:text-[#7cecc8]">
            Explore
            <FaArrowRightLong />
          </button>
        </div>
